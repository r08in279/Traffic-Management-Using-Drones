...
def draw_bounding_box_on_image_array(image,
  ...
  """
  image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
  listofclasses=draw_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    listofclasses.append(display_str)
    draw.rectangle(
...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  for box, color in box_to_color_map.items():
    ...
    what_it_gets=draw_bounding_box_on_image_array(
        image,
        ymin,
        xmin,
        ymax,
    ...
    #print(what_it_gets[0][0])
    if what_it_gets[0][0]=='n':
        
        lis[what_it_gets[0][0]+str(counts)]=(xmin, xmax, ymin, ymax)
    elif what_it_gets[0][0]=='f' :
        lis[what_it_gets[0][0]+str(counts)]=(xmin, xmax, ymin, ymax)
    else:
        lis[what_it_gets[0][0]+str(counts)]='noneed'
    if keypoints is not None:
